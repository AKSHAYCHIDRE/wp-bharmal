...
class CB_WC_Widget_Account extends WP_Widget {
	...
	function __construct() {
		...
		$this->woo_widget_cssclass = 'woocommerce widget_woocommerce_account';
		$this->woo_widget_description = __( 'WooCommerce Account', 'woocommerce' );
		$this->woo_widget_idbase = 'cb_woocommerce_account';
		$this->woo_widget_name = __( 'CB WooCommerce Account', 'woocommerce' );
	...
	function widget( $args, $instance ) {
		...
		wc_get_template( 'widgets/account.php' );
