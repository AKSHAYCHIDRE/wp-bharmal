...
class CB_WC_Widget_Catalog_Ordering extends WP_Widget {
	...
	function __construct() {
		...
		$this->woo_widget_cssclass = 'woocommerce widget_catalog_ordering';
		$this->woo_widget_description = __( 'Catalog Ordering', 'woocommerce' );
		$this->woo_widget_idbase = 'cb_woocommerce_catalog_ordering';
		$this->woo_widget_name = __( 'CB WooCommerce Catalog Ordering', 'woocommerce' );
