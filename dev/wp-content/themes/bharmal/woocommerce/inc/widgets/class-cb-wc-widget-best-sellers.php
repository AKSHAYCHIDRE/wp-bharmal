...
class CB_WC_Widget_Best_Sellers extends WP_Widget {
	...
	function __construct() {
		...
		$this->woo_widget_cssclass = 'woocommerce cb_widget_best_sellers';
		$this->woo_widget_description = __( 'Display a list of your best selling products on your site.', 'woocommerce' );
		$this->woo_widget_idbase = 'cb_woocommerce_best_sellers';
		$this->woo_widget_name = __( 'CB WooCommerce Best Sellers', 'woocommerce' );

		/* Widget settings. */
		$widget_ops = array( 'classname' => $this->woo_widget_cssclass, 'description' => $this->woo_widget_description );

		/* Create the widget. */
		$this->WP_Widget('cb_best_sellers', $this->woo_widget_name, $widget_ops);
	...
	function widget( $args, $instance ) {
		...
		$cache = wp_cache_get('cb_widget_best_sellers', 'widget');
		...
		if ( $r->have_posts() ) {
			...
			echo '<ul class="products best_sellers">';
		...
		wp_cache_set('cb_widget_best_sellers', $cache, 'widget');
	}
	...
	function update( $new_instance, $old_instance ) {
		...
		if ( isset($alloptions['cb_widget_best_sellers']) ) delete_option('cb_widget_best_sellers');
	...
	function flush_widget_cache() {
		wp_cache_delete( 'cb_widget_best_sellers', 'widget' );
	}
