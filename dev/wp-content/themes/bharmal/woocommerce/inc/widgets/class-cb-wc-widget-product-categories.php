...
class CB_WC_Widget_Product_Categories extends WP_Widget {
	...
	function __construct() {
		...
		$this->woo_widget_idbase = 'cb_woocommerce_product_categories';
		$this->woo_widget_name = __( 'CB WooCommerce Product Categories', 'woocommerce' );

		/* Widget settings. */
		$widget_ops = array( 'classname' => $this->woo_widget_cssclass, 'description' => $this->woo_widget_description );

		/* Create the widget. */
		$this->WP_Widget('cb_product_categories', $this->woo_widget_name, $widget_ops);
	...
	function widget( $args, $instance ) {
		...
		$cat_args = array( 'hide_empty' => false, 'show_count' => $c, 'hierarchical' => $h, 'taxonomy' => 'product_cat' );
		...
		if ( $d ) {
			...
			wp_list_categories( apply_filters( 'cb_woocommerce_product_categories_widget_args', $cat_args ) );
