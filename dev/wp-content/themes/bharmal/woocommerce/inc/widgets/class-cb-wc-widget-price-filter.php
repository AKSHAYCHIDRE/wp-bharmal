...
class CB_WC_Widget_Price_Filter extends WP_Widget {
	...
	function __construct() {
		...
		$this->woo_widget_idbase = 'cb_woocommerce_price_filter';
		$this->woo_widget_name = __( 'CB WooCommerce Price Filter', 'woocommerce' );
		...
		add_action( 'init', array(&$this, 'woocommerce_price_filter_init') );

		wp_deregister_script( 'wc-price-slider' );

		cb_script( 'cb-wc-price-slider', array(
			'src' => 'woocommerce/assets/js/price-slider.js',
			'enqueue' => false,
	...
	function widget( $args, $instance ) {
		...
		wp_enqueue_script( 'cb-wc-price-slider' );

		wp_localize_script( 'cb-wc-price-slider', 'woocommerce_price_slider_params', array(
